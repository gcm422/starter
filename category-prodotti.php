...
<section class="container container-prodotti">
<?php
/*
...
<?php
	...
	$thiscat_img_atts = wp_get_attachment_image_src( $thiscat_immagine_parte2 );
	if($thiscat_img_atts){
	$thiscat_img = $thiscat_img_atts[0];
...
<li class="column is-3">
	<div class="card">
		...
		<div class="content">
			<a href="/<?=$slug?>/<?=$thiscat_slug?>/" title="<?=$thiscat_h1?>">	
				<?=$thiscat_ancora_testuale?>
			</a>
		</div>
	</div>
</li>
